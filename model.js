...
*
* Este método carga el contenido del fichero DB_FILENMAE en la variable
...
* contenido incial almacenado en quizzes.
...
*
* Guarda en el formato JSON el valor de quizzes en el fichero DB_FILENAME.
...
/**
* Devuelve el número total de preguntas exitentes.
*
* @param {number}   número total de preguntas existentes.
*/
...
/**
* Devuelve todo los quizzes existentes.
*
...
/**
* Devuelve un clon del quiz almacenado en la posicioón dada.
*
